...
files = ["day1" "day3" "day3am" "day5" "day5am" "imm" "pre" "recent" "training"];
for file_index=1:number_of_sessions
    file_names{file_index}=fullfile(data_path,mice(k),files(file_index));
end
